...
export default function Vision() {
  return (
    <section className="relative z-10 w-full px-0 sm:px-6 lg:px-8 my-8 sm:my-12">
      <div
      ...
      >
        ...
        <div className="relative z-10 px-6 sm:px-10 lg:px-16 py-14 sm:py-20 lg:py-28 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          {/* Left Column */}
          <div>
            <motion.p
              variants={fadeInUp}
