...
import { Menu, X, ArrowRight, Sun, Zap, ShieldCheck } from 'lucide-react'
...
export default function Navbar() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      else if (delta > 6 && currentY > 80 && !mobileMenuOpen) setVisible(false)
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-x-3 top-[68px] z-[99] md:hidden bg-[#0a122d]/96 backdrop-blur-2xl rounded-3xl border border-white/15 p-6 shadow-[0_20px_50px_rgba(0,0,0,0.6)] text-white"
          >
            <div className="flex flex-col gap-5">
              {/* Top Section / Page Tabs */}
                ...
                {navItems.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`flex items-center justify-between p-3.5 rounded-2xl no-underline transition-colors ${
                        isActive
                          ? 'bg-[rgb(0,86,184)] text-white font-bold shadow-md'
              ...
              <div className="pt-2 border-t border-white/10 flex items-center justify-between text-xs text-white/50">
                ...
                <span className="font-mono text-[#4ade80]">hello@daraexpress.com</span>
              </div>
            </div>
          </motion.div>
        )}
